...
export default function getProjects() {
    return [
        ...
        },
        {
            ...
            projectInfo: "It is a online veternarian booking system where you can book veternarian for your pets",
            techUsed: ["HTML" , "CSS" , "JavaScript" ,"Node" , "Express" , "MongoDB"],
            projectLinkHosted: "https://cool-elf-0374a9.netlify.app/",
            projectLinkGithub: "https://github.com/shashikantRupin/Veterinary-apponitment-booking",
        },
        {
            id: 3,
        ...
        },
        {
            ...
            projectLinkGithub: "https://github.com/shashikantRupin/shashikantRupin.github.io",
        }
    ];
}