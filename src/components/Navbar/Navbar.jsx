...
function Navbar() {
    ...
    const downloadHandle = () => {
        ...
        link.download = "ShashikantRupin_Resume.pdf";
        link.href = MyResume;
        link.click();
        window.open(
            "https://drive.google.com/file/d/1p8iN9V_8LRnheG6BZ4QAytYSZ1_XnvYS/view",
            "_blank"
        );
    };
            ...
            <div id='nav-menu'>
                ...
                <div id="largeScreenNavbar">
                    ...
                    <div>
                        ...
                        <a href="https://github.com/shashikantRupin" target="_blank" className="nav-link github">
                            GitHub
                        </a>
                    </div>
                </div>
            ...
            </div >
            {
                burger ? (<div id='smallScreenDropDown' >
                    <div>
                        ...
                        <a href="https://github.com/shashikantRupin" target="_blank" className="nav-link github" style={{ margin: "auto", width: "100px" }}
