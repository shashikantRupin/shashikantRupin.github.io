...
function HomeSection() {
    const downloadHandle = () => {
        ...
        window.open(
            "https://drive.google.com/file/d/1p8iN9V_8LRnheG6BZ4QAytYSZ1_XnvYS/view?usp=sharing",
            "_blank"
        );
    };
    ...
    const githubHandle = () => {
        window.open(
            "https://github.com/shashikantRupin",
            "_blank"
        );
    };
    return (
        <div id='home'>
            <div id='left_home'>
                <div>
                    <h1>Hi, I am</h1>
                    <h1 id="user-detail-name">Shashikant Rupin</h1>
            ...
            <div id='right_home' >
                <img src="/Images/Raaz selfie.jpg" alt="" className="home-img" />
            </div>
        </div>
    )
}
