...
export default function About() {
  ...
  const handleDownload = () => {
    window.open(
      "https://drive.google.com/file/d/1OsySdMzWINe3SD-kOYNBrRgqYcxyGIlo/view?usp=sharing",
      "_blank"
    );
  };
      ...
      <div>
        <div data-aos="fade-up" className=" first">
          <p id="user-detail-intro">
            Welcome to my coding realm, where I transform coffee into lines of code! <p style={{ display: 'inline-block' }} className="sauce">I'm Shashikant Rupin</p>
            , a proficient full stack web developer.
            My expertise spans across HTML5, CSS, JavaScript, ReactJs, NodeJs, Express, and I'm well-versed in working with database
        ...
        <a
          ...
          rel="noreferrer" href={resume} download={"shashikant-rupin-resume"} id="resume-button-2" className="contact-button resume-button second-btn">
          Resume</a>
      </div>
    </section>
  );
